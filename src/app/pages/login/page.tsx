        ...
        <Box sx={{ minHeight: '100vh', bgcolor: gradient, py: { xs: 2, md: 6 } }}>
            <Stack alignItems="center" justifyContent="flex-start" sx={{ minHeight: '100vh', width: '100%' }}>
                <Paper elevation={8} sx={{ width: '100%', maxWidth: 400, mx: 'auto', p: { xs: 2, md: 4 }, borderRadius: 4, bgcolor: '#f7faff', boxShadow: 8 }}>
                    ...
                    >
                        <Typography variant="h5" align="center" sx={{ color: color1, fontWeight: 800, letterSpacing: 1, mb: 1 }}>Login</Typography>
                        <TextField
                            label="Email"
                            name="email"
                            type="email"
                        ...
                        {message && (
                            <Typography color={message.includes("successful") ? "primary" : "error"} align="center">
                                {message}
                            </Typography>
                        )}
                    </Box>
